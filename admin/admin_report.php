              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['name']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['phone']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['email']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['species']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['breed']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['age']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['numabuse']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['typeabuse']) . "</td>";
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['descript']) . "</td>";
                        ...
                        echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row['created_at']) . "</td>";
                        echo "</tr>";
                    }
                } else {
