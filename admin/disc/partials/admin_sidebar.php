...
<div id="sidebar" class="  bg-[#042752] text-white w-64 transition-width duration-300 min-h-screen flex flex-col sidebar-expanded font-poppins ">
    ...
    <nav class="flex-1 flex flex-col space-y-4 mt-4 p-4">
      ...
      <span class="sidebar-text"><h1 class="font-poppins">Settings</h1></span>
